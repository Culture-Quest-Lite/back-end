...
import org.sep490.backend.module.user.dto.request.CancelSubscriptionRequest;
...
public class PremiumSubscriptionController {
    ...
    public ResponseEntity<PremiumSubscriptionResponse> cancelSubscription(
            @PathVariable Long invoiceId,
            @RequestBody CancelSubscriptionRequest request) {
        return ResponseEntity.ok(premiumSubscriptionService.cancelSubscription(invoiceId, request.getReason()));
    }
}
